...
public class TABHook {
    ...
    public static void setTagPrefix(Player player, String string, boolean placeholder) {
        if (placeholder && Plugins.CMI.isEnabled() && string != null) string += CMIHook.GLOW_CODE_PLACEHOLDER;
    ...
    public static String getTabGroup(String group, Type type) {
